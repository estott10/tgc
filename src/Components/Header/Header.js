    ...
    return(
        <div className= "header">
            ...
            <div className="logo-menu" id="header-menu" style={{display: "flex", flexDirection:"row", justifyContent:"space-between"}}>
                <div className="logo" style={{width: "100px", height: "100px"}}><a href="https://squareup.com/store/goodchocolate" style={{width: "200px", height: "200px"}}><div></div></a></div>
                <div className="menu" style={{ display: 'flex', color: 'black', flexDirection: 'row', justifyContent: 'space-between'}}>
                    <p><a href="https://squareup.com/store/goodchocolate" style={{ textDecoration: 'none', color: 'black' }}>Order Here</a></p>
