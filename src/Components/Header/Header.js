    ...
    return(
        <div className= "header">
            <div className="sale-banner" style={{ textDecoration: 'none', color: 'white', margin:'0px'}}>
                ...
                <p style={{textAlign: 'center', marginBottom:'10px', marginTop: '0px', fontStyle:"italic", fontSize:"100%"}}> We are currently closed for the holidays. Any orders placed will not be fulfilled until Wednesday, January 1st. </p>
                </div>
