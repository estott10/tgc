  ...
  constructor(props){
    ...
    return(
        <div className="dashboard" style={{display: "flex", flexDirection:"column"}}>
            ...
            <button id="shop-now"><a href='https://thatsgoodchocolate-107815.square.site/s/shop' style={{textDecoration: "none", color:"white"}}>Shop Now</a></button>
            </div>
            <div id="mobile-buttonDiv">
            <button id="shop-nowMobile"><a href='https://thatsgoodchocolate-107815.square.site/s/shop' style={{textDecoration: "none", color:"white"}}>Shop Now</a></button>
            </div>
            <div style={{textAlign:'center'}}>
              <h2>Featured Products</h2>
              <div className="featured-row" style={{paddingBottom:'20px'}}>
                  <a href='https://thatsgoodchocolate-107815.square.site/s/shop' style={{textDecoration: "none", color: "black"}}>
